...
[[SummarizedExperiment]{.ul}](https://bioconductor.org/packages/release/bioc/vignettes/SummarizedExperiment/inst/doc/SummarizedExperiment.html)
...
[[magrittr]{.ul}](https://magrittr.tidyverse.org/) package or the \|\>
...
(**mt_reporting**), and data output (**mt_write**).
...
Annotations]{.ul}](#storing-pathway-annotations) for further details.
...
multi[variable]{.ul} (e.g. linear regression models with confounders),
but not multi[variate]{.ul}. That is they will calculate a separate
...
-   mtm_res_get_entries - extracts metadata(.)\$results in a given
    ...
    metadata]{.ul}](#storing-pipeline-steps-and-results-in-metadata) for
...
-   mtm_get_assay_by_id - return a specific assay version given a UUID
    ...
    Versions]{.ul}](#storing-assay-versions) for further details
...
[[SummarizedExperiment]{.ul}](https://bioconductor.org/packages/release/bioc/html/SummarizedExperiment.html).
...
-   **results** - a list containing the pipeline steps and results; see
    ...
    metadata]{.ul}***](#storing-pipeline-steps-and-results-in-metadata)
    for further details
...
-   **pathways** - a list containing the pathway dataset; see section
    [***[3.4 Storing Pathway
    Annotations]{.ul}***](#storing-pathway-annotations) for further
    details
...
**[3.2. Function and Argument Naming Rules & Conventions]{.ul}**
----------------------------------------------------------------
...
**[3.3. Storing Pipeline Steps and Results in metadata]{.ul}**
--------------------------------------------------------------
...
Versions]{.ul}](#storing-assay-versions) for more information about
...
**[3.4 Storing Pathway Annotations]{.ul}**
------------------------------------------
...
**[3.6. Internal Functions (mti\_)]{.ul}**
------------------------------------------
